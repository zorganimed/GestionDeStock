...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	.antMatchers("/role/**").hasAuthority("SUPERADMIN")// accès pour SUPERADMIN
	.antMatchers("/registration/**").hasAuthority("SUPERADMIN") // accès pour SUPERADMIN
	...
	.usernameParameter("email") // paramètres d'authentifications login etpassword
